...
- **`src/ui/theme.jsx`** — the light **GeeksforGeeks-style** theme: `C` color tokens (white bg, green `#2f8d46` accent, dark text) + shared primitives (`GlobalNav`, `Btn`, `Panel`, `SectionTitle`, `wrap`). Re-point the `C` tokens to retheme; most of the app reads them.
