  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "grid", data: { cells: [["m", "i", "s", "p"], [1, 4, 4, 2]], highlight: [[1, 0]], colors: { "1,0": "#1a7f37" } }, caption: 'Counter("mississippi"): top row items, bottom row counts. m is the only char with count 1 -> first unique.' },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "array", data: { values: [2, 7, 11, 15], pointers: [{ name: "i", index: 1, color: "#2f8d46" }], highlight: [0, 1], labels: { "0": "need=9-7=2 seen", "1": "x=7" } }, caption: "Two Sum, target=9: at i=1 the complement 2 is already in the map, so return [0, 1]." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "grid", data: { cells: [["eat", "tea", "tan", "ate", "nat"], ["aet", "aet", "ant", "aet", "ant"]], highlight: [[1, 0], [1, 1], [1, 3]], colors: { "1,0": "#1a7f37", "1,1": "#1a7f37", "1,3": "#1a7f37" } }, caption: "Group Anagrams: top row inputs, bottom row canonical key (sorted letters). Equal keys land in the same bucket." },
