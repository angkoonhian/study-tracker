  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "array", data: { values: [1, 3, 5, 7, 9, 11], window: [0, 5], pointers: [{ name: "lo", index: 0, color: "#6FA8FF" }, { name: "mid", index: 2, color: "#E0A23B" }, { name: "hi", index: 5, color: "#5FD79E" }], highlight: [2] }, caption: "Step 1: mid=2, nums[2]=5 < 7 → too small, lo = mid + 1 = 3." },
        { type: "p", text: `Step 2: lo=3, hi=5, mid=4, nums[mid]=9 > 7 — too big, so discard the right half: hi = mid - 1 = 3.` },
        { type: "diagram", kind: "array", data: { values: [1, 3, 5, 7, 9, 11], window: [3, 5], pointers: [{ name: "lo", index: 3, color: "#6FA8FF" }, { name: "mid", index: 4, color: "#E0A23B" }, { name: "hi", index: 5, color: "#5FD79E" }], highlight: [4] }, caption: "Step 2: mid=4, nums[4]=9 > 7 → too big, hi = mid - 1 = 3." },
        { type: "p", text: `Step 3: lo=3, hi=3, mid=3, nums[mid]=7 == 7 — found, return index 3. The window has collapsed onto the answer.` },
        { type: "diagram", kind: "array", data: { values: [1, 3, 5, 7, 9, 11], window: [3, 3], pointers: [{ name: "lo", index: 3, color: "#6FA8FF" }, { name: "mid", index: 3, color: "#E0A23B" }, { name: "hi", index: 3, color: "#5FD79E" }], highlight: [3], labels: { "3": "found" } }, caption: "Step 3: lo == hi == mid = 3, nums[3] = 7 → match, return 3." }
      ]
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "array", data: { values: [1, 3, 5, 5, 7, 9], pointers: [{ name: "lb", index: 2, color: "#6FA8FF" }, { name: "ub", index: 4, color: "#5FD79E" }], highlight: [2, 4], labels: { "0": "F", "1": "F", "2": "T", "3": "T", "4": "T", "5": "T" } }, caption: "Predicate nums[i] >= 5 reads F F T T T T. lower_bound(5)=2 (first T); upper_bound(5)=4 (first nums[i] > 5)." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "array", data: { values: [1, 2, 3, 4, 5, 6, 7, 8], pointers: [{ name: "lo", index: 0, color: "#6FA8FF" }, { name: "mid", index: 3, color: "#E0A23B" }, { name: "hi", index: 7, color: "#5FD79E" }], highlight: [3], labels: { "0": "F", "1": "F", "2": "F", "3": "T", "4": "T", "5": "T", "6": "T", "7": "T" } }, caption: "Koko answer space (candidate speeds 1..8): infeasible (F) below 4, feasible (T) from 4 on. The minimum feasible speed k=4 is the boundary." },
        ...
        { type: "diagram", kind: "array", data: { values: [1, 2, 3, 4, 5, 6, 7], pointers: [{ name: "lo", index: 0, color: "#6FA8FF" }, { name: "mid", index: 3, color: "#E0A23B" }, { name: "hi", index: 6, color: "#5FD79E" }], highlight: [2], labels: { "0": "T", "1": "T", "2": "T", "3": "F", "4": "F", "5": "F", "6": "F" } }, caption: "Maximise-the-minimum answer space (candidate gaps 1..7): feasible (T) for small gaps, infeasible (F) once too wide. Answer is the LARGEST T — gap=3." }
      ]
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "array", data: { values: [4, 5, 6, 7, 0, 1, 2], pointers: [{ name: "min", index: 4, color: "#5FD79E" }], highlight: [4], labels: { "0": "F", "1": "F", "2": "F", "3": "F", "4": "T", "5": "T", "6": "T" } }, caption: "Rotated array: predicate nums[i] <= nums[hi] is F...F T...T; the first T (index 4, value 0) is the pivot / minimum." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "grid", data: { cells: [[1, 3, 5, 7], [10, 11, 16, 20], [23, 30, 34, 60]], highlight: [[1, 1], [0, 2], [1, 2]], colors: { "1,1": "#E0A23B", "0,2": "#6FA8FF", "1,2": "#5FD79E" } }, caption: "Fully-sorted matrix as a virtual 1D array. Probed mids (amber, blue) narrow to the target 11 at (1,2) (green)." },
