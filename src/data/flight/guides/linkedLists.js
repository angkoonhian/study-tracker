  ...
  sections: [
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "linkedlist", data: { values: [1, 2, 3, 4, 5], cycleTo: -1, pointers: [{ name: "head", index: 0, color: "#2f8d46" }] }, caption: "A singly linked list. The head pointer identifies the chain; the last node's next is None." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "linkedlist", data: { values: [0, 1, 2, 3], cycleTo: -1, pointers: [{ name: "dummy", index: 0, color: "#1a7f37" }, { name: "head", index: 1, color: "#2f8d46" }] }, caption: "The dummy node (value 0) sits before the real head, so every real node has a predecessor. Return dummy.next at the end." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "linkedlist", data: { values: [1, 2, 3, 4], cycleTo: -1, pointers: [{ name: "head", index: 0, color: "#2f8d46" }] }, caption: "Before reversal: 1 -> 2 -> 3 -> 4." },
        { type: "diagram", kind: "linkedlist", data: { values: [4, 3, 2, 1], cycleTo: -1, pointers: [{ name: "prev/new head", index: 0, color: "#1a7f37" }] }, caption: "After reversal: every next pointer is flipped; prev becomes the new head (4 -> 3 -> 2 -> 1)." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "linkedlist", data: { values: [1, 2, 3, 4, 5], cycleTo: -1, pointers: [{ name: "slow", index: 2, color: "#2f8d46" }, { name: "fast", index: 4, color: "#E0A23B" }] }, caption: "Final positions for length 5: fast (amber) is at the tail, slow (blue) has landed on the middle node 3." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "linkedlist", data: { values: [1, 2, 3, 4, 5], cycleTo: 2, pointers: [{ name: "head", index: 0, color: "#2f8d46" }] }, caption: "A cycle: the tail (node 5) points back to node 3 (cycleTo: 2) instead of None, so fast will eventually lap slow inside the loop." },
        ...
        { type: "diagram", kind: "linkedlist", data: { values: [1, 2, 3, 4, 5], cycleTo: 2, pointers: [{ name: "ptr", index: 0, color: "#1a7f37" }, { name: "slow", index: 2, color: "#2f8d46" }], highlight: [2] }, caption: "Finding the entry: reset ptr (green) to head and walk both at the same speed. They meet at node 3 — the cycle's start (cycleTo: 2)." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "diagram", kind: "linkedlist", data: { values: [1, 3, 5], cycleTo: -1, pointers: [{ name: "l1", index: 0, color: "#2f8d46" }] }, caption: "First sorted input list: 1 -> 3 -> 5." },
        ...
        { type: "diagram", kind: "linkedlist", data: { values: [1, 2, 3, 4, 5, 6], cycleTo: -1, pointers: [{ name: "head", index: 0, color: "#1a7f37" }] }, caption: "Merged result: nodes from both lists interleaved into sorted order (1 -> 2 -> 3 -> 4 -> 5 -> 6)." },
