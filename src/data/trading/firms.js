...
export const FIRMS = [
  {
    ...
    sources: [
      ...
      "Glassdoor — Hudson River Trading SWE interviews",
      "Wall Street Oasis — HRT interview entries",
    ],
  },
  {
    id: "jane-street",
    ...
    sources: [
      ...
      "Glassdoor — Jane Street SWE interviews",
    ],
  },
  {
    ...
    sources: [
      ...
      "Glassdoor — Citadel / Citadel Securities SWE interviews",
